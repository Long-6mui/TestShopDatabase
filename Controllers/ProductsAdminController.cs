...
namespace ShopOnline.Controllers
{
    public class ProductsAdminController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductID,NamePro,DecriptionPro,IDCate,Price,ImagePro")] Product products, HttpPostedFileBase file)
        {
            if (!IsAdminLoggedIn())
            {
                return RedirectToAction("Login", "Admin");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductID,NamePro,DecriptionPro,IDCate,Price,ImagePro")] Product products, HttpPostedFileBase file)
        {
            if (!IsAdminLoggedIn())
            {
                return RedirectToAction("Login", "Admin");
